...
std::array<T, N> sumArrays(const std::array<T, N> &a,
...
template <typename T, size_t N>
std::array<T, N> divideArrays(const std::array<T, N> &a,
                              const std::array<T, N> &b) {
    std::array<T, N> result;
    for (size_t i = 0; i < N; ++i) {
...
template <typename T, size_t N>
std::array<T, N> multiplyArrays(const std::array<T, N> &a,
                                const std::array<T, N> &b) {
    std::array<T, N> result;
    for (size_t i = 0; i < N; ++i) {
        result[i] = a[i] * b[i];
...
template <typename T, size_t N>
std::array<T, N> subtractArrays(const std::array<T, N> &a,
                                const std::array<T, N> &b) {
    std::array<T, N> result;
    for (size_t i = 0; i < N; ++i) {
        result[i] = a[i] - b[i];
...
template <typename T, size_t N>
std::array<T, N> getMean(const std::vector<std::array<T, N>> &vectors) {
...
template <typename T, size_t N>
std::array<T, N> getStdDev(const std::vector<std::array<T, N>> &vectors,
